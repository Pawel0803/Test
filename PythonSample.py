...
def receive_new_frame_with_data(data_dict):
    ...
    if dump_args is True:
        ...
        for key in data_dict:
            ...
            out_string += "/"
        print(out_string)
    # print(dir(data_dict['mocap_data']))
    print(data_dict['mocap_data'].rigid_body_data.rigid_body_list[0].rb_marker_list)
    print(data_dict['mocap_data'].rigid_body_data.rigid_body_list[1].rb_marker_list)
    print(data_dict['mocap_data'].rigid_body_data.rigid_body_list[2].rb_marker_list)
    print(data_dict['mocap_data'].rigid_body_data.rigid_body_list[3].rb_marker_list)
    print(data_dict['mocap_data'].rigid_body_data.rigid_body_list[4].rb_marker_list)
